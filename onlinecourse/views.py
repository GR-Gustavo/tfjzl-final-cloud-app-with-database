...
# Submit view: creates an exam submission record for a course enrollment
...
# Exam result view: checks if the learner passed the exam and shows the result for each question
